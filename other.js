...
$(function () {
  ...
  var vote_url = base_url + "/vote/" + data_vote_id + "";
...
function comment_send(type) {
  ...
  var comment_url = base_url + "/comment";
...
function submission_send() {
  ...
  var submission_url = base_url + "/submission";
...
function contact_form_send() {
  ...
  var contact_url = base_url + "/contact-form";
